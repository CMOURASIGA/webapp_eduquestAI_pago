    ...
    <div className="pb-12">
      ...
      <header className="mb-10 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Transforme conteúdo bruto em um simulado inteligente de {QUESTIONS_PER_EXAM} questões.</p>
        </div>
        ...
        <div className="space-y-6">
          <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 space-y-4">
            ...
            <p className="text-[10px] text-center text-slate-400 uppercase tracking-widest font-bold">
              {QUESTIONS_PER_EXAM} QUESTÕES • ESTILO ENEM • BNCC
            </p>
          </section>
        </div>
      </form>
