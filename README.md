...
- Acesso gratuito inicial: cada conta pode ativar uma unica vez (`FREE_ONCE_*`) para 1 execucao inicial.

## Smoke test operacional

- Execute `npm run test:smoke-billing` para validar: cadastro, login, ativacao gratuita unica, listagem de planos e criacao de checkout.
